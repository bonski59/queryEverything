...
csv_mission_splunk = './output/splunk_mission_queries.csv'
csv_elastic = '../elastic_scrape/elastic_research_output.csv'

csv_brf = '../brf/brf_data.csv'

txt_tcodes = "./input/All_Tcodes_final.txt"

notmatch_tags = "./input/notmatch_tags.txt"
